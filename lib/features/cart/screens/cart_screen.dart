                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ...
                  Transform.scale(
                    ...
                    child: Switch(
                      ...
                      activeColor: Theme.of(context).primaryColor, // thumb ON
                      activeTrackColor: Theme.of(context).primaryColor, // track ON
                      inactiveThumbColor: Colors.grey, // thumb OFF
                      inactiveTrackColor: Theme.of(context).primaryColor.withOpacity(0.5), // track OFF
                    )
